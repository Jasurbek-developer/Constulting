...
const changeLanguage=()=>{
    ...
    document.querySelector(".customer-big-title").innerHTML=langsArr["customer-big-title"][hash]
    document.getElementById("customer-text-1").innerHTML=langsArr["customer-text-1"][hash]
